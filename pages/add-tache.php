...
if(isset($_POST['submit'])){
	...
	$obj=new DbFunction();
	$obj->create_tache($_POST['titre'],$_POST['description'],$_POST['creele'],$_POST['avantle']);
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Ajouter Tache</div>
							...
							<div class="row">
						 	<div class="col-lg-10">
										...
										<div class="form-group">
											<div class="col-lg-4">
					 <label>Titre<span id="" style="font-size:11px;color:red">*</span>	</label>
											</div>
											<div class="col-lg-6">
  ...
  <input class="form-control" name="titre" id="titre">       
	...
	<span id="course-status" style="font-size:12px;"></span>				</div>
	 ...
	 <div class="form-group">
		...
		<div class="col-lg-6">
		<input class="form-control" name="creele" id="creele">         
	<span id="course-status" style="font-size:12px;"></span>				</div>
	 </div>	
	...
	<div class="form-group">
	<div class="col-lg-4">
	 <label> A Terminer avant le:<span id="" style="font-size:11px;color:red">*</span></label>
	</div>
	<div class="col-lg-6">
		<input class="form-control" name="avantle" id="avantle" >         
	<span id="course-status" style="font-size:12px;"></span>				</div>
	 </div>	
	</div>
	</div>	
		...
		<br><br>		
							...
							<input type="submit" class="btn btn-primary" name="submit" value="Creer Tache" ></button>
											</div>
