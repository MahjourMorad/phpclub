...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  Dim 09 juin 2019 à 21:13
...
INSERT INTO `membre` (`id`, `nom`, `prenom`, `filiere`) VALUES
(1, 'mom12', 'prenom1', 'fil1'),
(2, 'mom2', 'prenom2', 'fil2'),
(3, 'mom12', 'prenom1', 'fil1'),
(4, 'mom4', 'prenom4', 'fil4'),
(5, 'name4', 'prenom4', 'fil4');
...
INSERT INTO `projet` (`id`, `title`, `description`, `chefprojet`) VALUES
(1, 'pr1', 'something1', 'chef1'),
(2, 'pr2', 'something2', 'chef2'),
(3, 'pr3', 'something3', 'chef3');
...
CREATE TABLE IF NOT EXISTS `taches` (
  ...
  `description` varchar(255) NOT NULL,
  `creele` varchar(255) NOT NULL,
  `avantle` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;
...
INSERT INTO `taches` (`id`, `titre`, `description`, `creele`, `avantle`) VALUES
(1, 'tache12', 'description1', '04-06-2019', '19-09-2019'),
(2, 'tache21', 'description2', '01-06-2019', '23-04-2019'),
(3, 'tache3', 'description3', '01-06-2019', '23-07-2019');
